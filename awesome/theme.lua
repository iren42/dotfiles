...
theme.widget_micMuted                           = gfs.get_configuration_dir() .. "widgets/icons/micMuted2.png"
theme.widget_micUnmuted                         = gfs.get_configuration_dir() .. "widgets/icons/micUnmuted2.png"
